...
parameter "param_appcode" do 
  ...
  type "string" 
  allowed_values "(Yellow) github.com/rightscale/examples:unified_php", "(Blue) github.com/MitchellGerdisch/demo_support_files:unified_php_modified" 
  default "(Blue) github.com/MitchellGerdisch/demo_support_files:unified_php_modified"
